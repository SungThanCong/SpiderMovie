...
export const PaymentReturn = (props) => {
    ...
    useEffect(() => {
        ...
        dispatch(ACTIONS.DeleteAllMovieCart())
        dispatch(ACTIONS.GetMyMovies())
    },[])
                    ...
                    <td className="container" width="600">
                        <div className="content">
                        {
                                ...
                                <tbody><tr>
                                    <td className="content-wrap aligncenter">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td className="content-block">
                                                    <table className="invoice">
                                                        <tbody><tr>
                                                            <td>{Information.username}<br/>Invoice<br/></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <table className="invoice-items" cellpadding="0" cellspacing="0">
                                                                    <tbody>
                                                                    {
                                                                        ...
                                                                        return (
                                                                            <tr>
                                                                                <td>{value.title}</td>
                                                                                <td className="alignright">$ {value.price}</td>
                                                                            </tr>
                                                                        )})
                                                                    }
                                                                    ...
                                                                    <tr className="total">
                                                                        ...
                                                                        <td className="alignright">$ {totalPrice}</td>
                                                                    </tr>
                                                                </tbody></table>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr>
                                                <td className="content-block">
                                                    <Link to='/product'>View in browser</Link>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td className="content-block">
                            ...
                            <div className="footer">
                                <table width="100%">
                                    <tbody><tr>
                                        <td className="aligncenter content-block">Questions? Email <a href="mailto:20521133@gmail.com">support@spider.com</a></td>
                                    </tr>
                                </tbody></table>
                            </div></div>
                        </td>
